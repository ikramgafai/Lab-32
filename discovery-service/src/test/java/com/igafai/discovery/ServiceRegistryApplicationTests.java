...
/**
 * Integration tests for the Service Registry Application.
 * 
 ...
 * as a basic smoke test to ensure the Eureka server can start without errors.</p>
 * 
...
class ServiceRegistryApplicationTests {
     ...
     * that the Eureka server can start without errors. If this test passes, it
